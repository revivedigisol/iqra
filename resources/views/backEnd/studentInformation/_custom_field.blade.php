                    ...
                    <div class="no-gutters input-right-icon">
                        <div class="col">
                            <div class="primary_input ">
                                ...
                                <input
                                    class="primary_input_field date form-control{{ $errors->has('customF.'.$custom_field->label) ? ' is-invalid' : '' }}"
            ...
            @elseif($custom_field->type == 'dropdownInput')
                ...
                <div class="{{ $custom_field->width }}">
                    <div class="primary_input ">
                        ...
                        <select class="primary_select  form-control{{ $errors->has('customF.'.$custom_field->label) ? ' is-invalid' : '' }}"
                            name="customF[{{ $custom_field->label }}]">
                            <option
                            ...
                            <div class="primary_input ">
                                ...
                                @if ($errors->has('customF.'.$custom_field->label))
                                    <span class="text-danger d-block">
                                        <strong>{{ @$errors->first('customF.'.$custom_field->label) }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
